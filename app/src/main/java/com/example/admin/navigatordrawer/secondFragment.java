...
public class secondFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            GeoJsonLayer geoJsonLayer= new GeoJsonLayer(googleMap, R.raw.earthquake, getActivity());
    ...
    public void readContacts(){
        if (ActivityCompat.checkSelfPermission(getActivity(),Manifest.permission.READ_CONTACTS) == PackageManager.PERMISSION_GRANTED){
            ...
            Cursor cursor= getActivity().managedQuery(allContacts, null, null, null, null);
            ...
            ActivityCompat.requestPermissions(getActivity(), new String[]{Manifest.permission.READ_CONTACTS}, 2018);
        }
    }
