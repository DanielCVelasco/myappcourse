...
import com.example.admin.navigatordrawer.Networking.postStringRequest;
...
public class SixthFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        cardInputWidget= getView().findViewById(R.id.cardImporWidget);

        scanButton= getActivity().findViewById(R.id.scanButton);
    ...
    private void processPayment(){
        ...
        if (card.validateCard()){
            Stripe stripe= new Stripe(getActivity(), "pk_test_ihKovFGxcrGGDoV57lkWRtax");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (data.hasExtra(CardIOActivity.EXTRA_SCAN_RESULT)){
            ...
            Log.d("App", "CardNumber: " + creditCard.cardNumber);
            Log.d("App", "Month: " + creditCard.expiryMonth);
            Log.d("App", "Year: " + creditCard.expiryYear);
